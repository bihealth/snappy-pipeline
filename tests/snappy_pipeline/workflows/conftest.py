...
@pytest.fixture
def germline_large_cohort_trio_only_sheet_fake_fs(
    fake_fs, tsv_large_cohort_trios_only_germline_sheet
):
    """Return fake file system setup with files for tsv_large_cohort_trios_only_germline_sheet"""
    # Create work directory
    fake_fs.fs.makedirs("/work", exist_ok=True)
    # Create the sample TSV file
    fake_fs.fs.create_file(
        "/work/config/sheet_large_cohort_trio_only.tsv",
