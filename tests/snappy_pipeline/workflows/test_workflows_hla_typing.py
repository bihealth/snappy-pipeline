...
def test_optitype_step_part_get_args_input(hla_typing_workflow_optitype):
    ...
    expected = {
        "input": {
            "reads_left": [
                "hla_typing_optitype/work/input_links/P001-T1-DNA1-WGS1/FCXXXXXX/L001/P001_T1_DNA1_WGS1_R1.fastq.gz"
            ],
            "reads_right": [
                "hla_typing_optitype/work/input_links/P001-T1-DNA1-WGS1/FCXXXXXX/L001/P001_T1_DNA1_WGS1_R2.fastq.gz"
            ],
        },
        "seq_type": "dna",
