# -*- coding: utf-8 -*-
"""Code for testing gatk_ug_par wrapper"""
...
from snappy_wrappers.wrappers.gatk_ug_par.parallel_gatk_ug import ParallelGatkUgWrapper
...
def snakemake_obj(minimal_config):
    ...
    rule_name = "variant_calling_gatk_ug_run"
    threads = 2
    bench_iteration = 2
    script_dir = "/work"
    input_dict = {
    ...
    output_base_name = "work/bwa.gatk_ug.P001-N1-DNA1-WGS1/out/bwa.gatk_ug.P001-N1-DNA1-WGS1"
    output_dict = {
    ...
    log_base_name = "work/bwa.gatk_ug.P001-T1-DNA1-WGS1/log/bwa.gatk_ug.P001-T1-DNA1-WGS1"
    log_dict = {
    ...
    params_dict = {"step_key": "variant_calling", "caller_key": "gatk_ug"}
...
def test_gatk_ug_wrapper_run_construct_merge_rule(snakemake_obj, variant_caller_fake_fs, mocker):
    """Tests ParallelGatkUgWrapper.construct_merge_rule()"""
    # Patch out file-system
    patch_module_fs("snappy_wrappers.wrapper_parallel", variant_caller_fake_fs, mocker)
    wrapper_par = ParallelGatkUgWrapper(snakemake=snakemake_obj)
    # Define expected
    data_path = (Path(__file__).parent / "data/gatk_ug_par.snakemake").resolve()
