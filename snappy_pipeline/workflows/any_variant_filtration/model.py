...
class AnyVariantFiltration(SnappyStepModel):
    path_variant: Annotated[
        str,
        Field(
            alias="path_somatic_variant",
            examples=["../somatic_variant_annotation", "../somatic_variant_calling"],
        ),
    ]
    ...
    """Default: use those defined in variant calling step"""

    tools_variant_annotation: Annotated[
        list[str], Field(alias="tools_somatic_variant_annotation")
    ] = []
