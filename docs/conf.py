...
# -*- coding: utf-8 -*-
#
# snappy_pipeline documentation build configuration file, created by
...
exclude_patterns = ["_build", "step/DEFAULT_CONFIG_*.rst"]
...
# -- Write out RST for DEFAULT_CONFIG automatically -------------------
